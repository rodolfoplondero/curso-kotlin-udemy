...
// Mock -> Dados fictícios, que não são geradas ou buscadas de banco de dados
class Mock {
    ...
    private val mListPhrases = listOf<Phrase>(
        ...
        Phrase("Insanidade é fazer sempre a mesma coisa esperando um resultado diferente.", happy),
        Phrase("Não pare quando estiver cansado, pare quando tiver terminado.", happy),
        Phrase("O que você pode fazer agora que tem o maior impacto sore o seu sucesso?", happy),
        ...
        Phrase("Fracasso é o condimento que da sabor ao sucesso.", sunny),
